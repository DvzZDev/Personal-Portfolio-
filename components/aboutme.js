      ...
      <div className="ml-12 mr-12 mt h-2/3 w-auto flex flex-col-reverse object-center justify-center items-center mt-10 mb-20">
        <div className="max-w-4xl font-light ">
          ...
          >
            ...
            . En <b className="text-pink-400 font-bold">2023</b>, tuve mi primer
            contacto con la programación cuando la incluyeron en mis clases.{" "}
            <b className="text-pink-400 font-bold">
              Al principio, no sabía si me iba a gustar
            </b>
            , pero conforme fui aprendiendo, descubrí que era algo que realmente
            disfrutaba😊. Ahora, dedico la mayor parte de mi tiempo a{" "}
            <b className="text-pink-400 font-bold">explorar y aprender </b>
